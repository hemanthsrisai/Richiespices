      ...
      <section className="section bg-paper">
        <div className={`container ${styles.companyContainer}`}>
          <div className={styles.companyContent}>
            ...
            <p>
              Founded in 2022 in the bustling commercial hub of Wazirpur Industrial Area, Delhi, India, <strong>Richie Spices Pvt. Ltd.</strong> emerged with a singular goal: to deliver the unadulterated, authentic taste of Indian spices to the world.
            </p>
            <p>
